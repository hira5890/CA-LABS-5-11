...
HD_PWD='C:/Users/hira6/Downloads/lab la - Copy/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RF_ALU_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RF_ALU_TOP.tcl
