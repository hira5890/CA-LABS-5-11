...
HD_PWD='C:/Users/hira6/Downloads/lab la - Copy/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RF_ALU_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RF_ALU_TOP.tcl -notrace
