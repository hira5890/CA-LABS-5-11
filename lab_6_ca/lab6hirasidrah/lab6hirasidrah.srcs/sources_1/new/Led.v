...
module leds(
    input clk,
    input rst,
    input [31:0] writeData,   // data to show on LEDs
    input writeEnable,         // write enable
    input readEnable,          // read enable (optional)
    input [29:0] memAddress,   // not used for now

    output reg [31:0] readData = 32'b0, // optional readback
    output reg [15:0] leds    // actual LEDs
);

    integer i;
    reg [7:0] ledBytes [3:0]; // optional internal bytes
