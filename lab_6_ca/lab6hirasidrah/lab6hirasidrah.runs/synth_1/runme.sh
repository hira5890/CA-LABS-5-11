...
HD_PWD='C:/Users/hira6/Downloads/lab_6_ca/lab6hirasidrah/lab6hirasidrah.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_TOP_SWITCH.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_TOP_SWITCH.tcl
