...
HD_PWD='C:/Users/hira6/Downloads/lab_6_ca/lab6hirasidrah/lab6hirasidrah.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_TOP_SWITCH.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_TOP_SWITCH.tcl -notrace
